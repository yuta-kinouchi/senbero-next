    ...
    const result = await prisma.$transaction(async (tx) => {
      ...
      const newRestaurant = await tx.restaurant.create({
        data: {
          ...
          latitude: restaurantData.latitude ? parseFloat(restaurantData.latitude) : 0,
          longitude: restaurantData.longitude ? parseFloat(restaurantData.longitude) : 0,
          ...
          set_price: restaurantData.set_price ? parseInt(restaurantData.set_price) : null,
          signature_menu: restaurantData.signature_menu || null,
          has_hoppy: restaurantData.has_hoppy || false,
          solo_friendly: restaurantData.solo_friendly || false,
          nearest_station: restaurantData.nearest_station || null,
          happy_hour_description: restaurantData.happy_hour_description || null,
          qr_payment: restaurantData.qr_payment || false,
        },
      });
